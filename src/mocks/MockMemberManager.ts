...
export class MockMemberManager {
   ...
   * @async
   */
  public async fetch(): Promise<Collection<string, MockMember>>;
  /**
   ...
   * @async
   */
  public async fetch(id: string): Promise<MockMember | null>;
  /**
   ...
   * @public
   */
  public async add(user: MockUser): Promise<MockMember> {
